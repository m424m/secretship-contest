<template>
  <main class="text-page">
    ...
    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc orci orci, finibus eget
      ...
      condimentum. Fusce nec convallis ex, et tincidunt justo. Pellentesque nec lorem tortor.
      Pellentesque rhoncus, justo a scelerisque ornare, lorem purus imperdiet lorem, et volutpat
      mauris nisl et nibh.</p>

    <h2>Nulla eu varius felis, vel molestie diam</h2>
    <p>Donec erat erat, sodales id lacus ac, porttitor varius ex. Nulla facilisi. Nulla malesuada
      hendrerit volutpat. Suspendisse id tellus id nisi sodales fermentum. Pellentesque vitae
      blandit libero.</p>
